...
export default {
  ...
  GIT_PASSWORD_SECRET_TEMPLATE_FILE_PATH: path.resolve("./dist", "./templates/kubernetes/git_token_secret.yml"),
  PVC_TEMPLATE_FILE_PATH: path.resolve("./dist", "./templates/kubernetes/pvc.yml")
}
